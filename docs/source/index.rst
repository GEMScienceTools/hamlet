==================================================
Hamlet: Hazard Model Testing and Evaluation
==================================================

Hamlet (``openquake.hme``) is a Python package developed (OK, in development)
for qualitative and quantitative testing of Probabiblistic Seismic Hazard
Analysis (PSHA) models. Hamlet is developed by the `GEM Foundation`_, and uses
the OpenQuake_ software extensively.
